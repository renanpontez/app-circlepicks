export default {
  ...
  auth: {
    error: {
      ...
      appleNoToken: 'Falha ao obter token de identidade da Apple',
    },
  },
  report: {
    ...
    successMessage: 'Obrigado por ajudar a manter nossa comunidade segura.',
    error: 'Falha ao enviar denúncia',
  ...
  deleteAccount: {
    ...
    confirmMessage: 'Isso vai excluir permanentemente sua conta e todos os seus dados, incluindo suas indicações, salvos e seguidores. Essa ação não pode ser desfeita.',
