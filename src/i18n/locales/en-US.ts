export default {
  ...
  auth: {
    error: {
      ...
      appleNoToken: 'Failed to get Apple identity token',
    },
  },
  report: {
  ...
  deleteAccount: {
    ...
    confirmMessage: 'This will permanently delete your account and all your data, including your experiences, bookmarks, and followers. This action cannot be undone.',
